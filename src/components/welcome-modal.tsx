            ...
            <DialogHeader className="relative flex flex-row items-start justify-between px-8 pt-8 pb-6">
              <div>
                <DialogTitle className="flex items-center gap-2 text-4xl font-bold tracking-tight">
                  AI Portföyüme Hoş Geldiniz
                </DialogTitle>
                <DialogDescription className="mt-2 text-base">
                  {/*Etkileşimli AI portföy deneyimim*/}
                </DialogDescription>
              </div>
              <Button
                variant="ghost"
              ...
              <section className="bg-accent w-full space-y-8 rounded-2xl p-8">
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-accent-foreground text-base leading-relaxed">
                    <strong>Yepyeni AI Portföyümü</strong> sunmaktan çok heyecanlıyım.
                    <br /> İster bir işveren, ister arkadaş, aile üyesi ya da sadece meraklı biri olun, 
                    istediğiniz her şeyi sormaktan çekinmeyin!
                  </p>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <p className="text-accent-foreground text-base leading-relaxed">
                    Geleneksel portföyler sınırlayıcı olabilir. <br /> Her ziyaretçinin 
                    özel ihtiyaçlarına uyum sağlayamazlar. <br /> Benim portföyüm{' '}
                    <strong>
                      tam olarak sizin benimle ve çalışmalarımla ilgili merak ettiğiniz 
                      şeylere dönüşür.
                    </strong>
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center px-8 pt-4 pb-0 md:pb-8">
              ...
              >
                <p className="text-muted-foreground">
                  Sevdin mi, lütfen paylaş! Geri bildirim her zaman hoş gelir.
                </p>
