...
export function Presentation() {
  ...
  const profile = {
    ...
    location: 'Türkiye',
    description:
      'Merhaba 👋\nBen Melisa Çiçek Soyubey. Bilgisayar Mühendisliği öğrencisiyim ve web geliştirme, REST API\'ler, PostgreSQL ve siber güvenlik alanlarında kendimi geliştiriyorum. Boş zamanlarımda kitap okumayı, yürüyüş yapmayı, yeni yerler keşfetmeyi ve kickboks ile ilgilenmeyi seviyorum.',
    src: '/avatar3.png',
    fallbackSrc:
