...
const questions = {
  Me: 'Sen kimsin? Seni daha iyi tanımak istiyorum.',
  Projects: 'Hangi projeler üzerinde çalıştın? Şu anda neler yapıyorsun?',
  Skills: 'Yeteneklerin neler? Bana yumuşak ve teknik yeteneklerinin listesini ver.',
  Fun: "Hayatında yaptığın en çılgın şey nedir? Hobilerin neler? ",
  Contact:
    'Sana nasıl ulaşabilirim? Seni hemen "evet" diyebilmem için hangi tür bir proje gerekir?',
};
...
// Yardımcı çekmeçesi verileri
const specialQuestions = [
  'Dağ Bisikleti dedin mi?? Göster bana!',
  'Sen kimsin?',
  'Özgeçmişimi görebilir miyim?',
  'Hangi projelerin için en gururlu hissediyorsun?',
  'Yeteneklerin neler?',
...
const questionsByCategory = [
  ...
  },
  {
    ...
    questions: [
      'Özgeçmişimi görebilir miyim?',
      'Seni değerli bir takım üyesi yapan şey nedir?',
  ...
  },
  {
    ...
    name: 'Projeler',
    icon: CodeIcon,
    questions: ['Hangi projelerin için en gururlu hissediyorsun?'],
  },
  {
    id: 'skills',
    name: 'Yetenekler',
    ...
    questions: [
      'Yeteneklerin neler?',
      'École 42\'deki deneyimin nasıldı?',
    ],
  },
  {
    id: 'fun',
    ...
    questions: [
      ...
      "Hayatında yaptığın en çılgın şey nedir?",
      'Mac mı yoksa PC mi?',
      '%90 insanın yanlış aldığı ne konusunda emin oldukça?',
    ],
  },
  {
    id: 'contact',
    name: 'İletişim & Gelecek',
    icon: MailIcon,
    questions: [
      'Sana nasıl ulaşabilirim?',
      "Seni hemen 'evet' diyebilmem için hangi tür bir proje gerekir?",
      'Nerede yaşıyorsun?',
    ],
  },
];
